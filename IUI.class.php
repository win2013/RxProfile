...
class IUI {
    ...
    public function Select($name, $options) // An array of value, string pair
    {
        echo self::SELECT.$name."\">";
   ...
   public function drawImage($src = "http://rxprofile.com/rxprofile.png", $width, $height) {
       echo "<p><img src=\"".$src."\"  width=\"".$width."\"  height=\"".$height."\" </> </p>";
   }
